function WarnungsNarchichtErstellen(
    ...
    const beschreibung4 =
        ". Falls Seh-renen, Warnung der Bevölkerung heulen, welcher ein Auf- und Abschwellender heulton ist, befolgen sie folgende Schritte:";
    const beschreibung5 =
    ...
    const ende = ". Diese Angaben sind ohne Gewähr. Das verwendete Sprach-Modell kann Telefonnummern, Uhrzeiten und Informationen falsch vorlesen. Bitte überprüfen Sie diese in der NINA App. Befolgen Sie ausschließlich offizielle Anweisungen der Behörden.";
    const beschreibung6 = "Falls Seh-renen, Entwarnung heulen, welcher ein 60 sekündiger Dauerton ist, ist diese oder eine andere Warnung aufgehoben.";
    ...
    var beschreibung7 = `Falls es weitere zu ergreifende Maßnahmen bezüglich der Warnung gibt, werden diese nun vorgelesen. ${instruction}.`;
